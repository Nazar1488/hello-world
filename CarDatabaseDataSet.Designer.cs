...
namespace Завдання_3__Car_ {
    ...
    public partial class CarDatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public TableRow AddTableRow(string Brand, int Year, decimal Cost) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public TableRow FindByBrand(string Brand) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public decimal Cost {
                get {
                    return ((decimal)(this[this.tableTable.CostColumn]));
                }
                set {
...
namespace Завдання_3__Car_.CarDatabaseDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([Brand] = @Original_Brand) AND ([Year] = @Origi" +
                "nal_Year) AND ([Cost] = @Original_Cost))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Brand], [Year], [Cost]) VALUES (@Brand, @Year, @Cost)" +
                ";\r\nSELECT Brand, Year, Cost FROM [Table] WHERE (Brand = @Brand)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Table] SET [Brand] = @Brand, [Year] = @Year, [Cost] = @Cost WHERE (" +
                "([Brand] = @Original_Brand) AND ([Year] = @Original_Year) AND ([Cost] = @Origina" +
                "l_Cost));\r\nSELECT Brand, Year, Cost FROM [Table] WHERE (Brand = @Brand)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Завдання_3__Car_.Properties.Settings.Default.CarDatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Brand, Year, Cost FROM dbo.[Table]";
        ...
        public virtual int Fill(CarDatabaseDataSet.TableDataTable dataTable) {
        ...
        public virtual CarDatabaseDataSet.TableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CarDatabaseDataSet.TableDataTable dataTable = new CarDatabaseDataSet.TableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CarDatabaseDataSet.TableDataTable dataTable) {
        ...
        public virtual int Delete(string Original_Brand, int Original_Year, decimal Original_Cost) {
        ...
        public virtual int Insert(string Brand, int Year, decimal Cost) {
            if ((Brand == null)) {
        ...
        public virtual int Update(string Brand, int Year, decimal Cost, string Original_Brand, int Original_Year, decimal Original_Cost) {
            if ((Brand == null)) {
                throw new global::System.ArgumentNullException("Brand");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int Year, decimal Cost, string Original_Brand, int Original_Year, decimal Original_Cost) {
            return this.Update(Original_Brand, Year, Cost, Original_Brand, Original_Year, Original_Cost);
        }
    }
